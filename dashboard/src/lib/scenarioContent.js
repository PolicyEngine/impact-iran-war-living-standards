export const SCENARIO_CONTENT = {
  low_shock: {
    ...
    description:
      "The conflict de-escalates and prices stabilise where they already are: Brent ~$85/bbl, energy spending +15% (in line with the observed July 2026 cap rise plus Cornwall Insight's Q4 forecast), fuel +20% (today's pump prices), food +2%, CPI +1pp — the cost of the conflict as it has already happened, sustained for 12 months.",
  },
  central_shock: {
    shortLabel: "Central",
