...
|---|---|---|---|---|
| Low | +15% | +20% | +2.0% | +1.3pp |
| Central | +45% | +40% | +4.0% | +3.1pp |
| High | +90% | +55% | +6.5% | +5.3pp |
...
| | Low | Central | High |
|---|---:|---:|---:|
| Mean cost per household | £517 | **£1,272** | £2,232 |
| Total cost | £16.3bn | **£40.2bn** | £70.5bn |
| People newly below the anchored poverty line | 359,642 | **1,275,745** | 2,281,982 |
| Mean of per-household cost/income ratios | 1.7% | **4.3%** | 7.7% |
| Total cost ÷ total net income | 0.9% | **2.2%** | 3.9% |
...
Central-scenario cost by channel, per household: energy £713, fuel £413, food £147. The uprating compensation shortfall is a further £84, reported separately rather than added (see above).

The shock is regressive on either basis. Under the central scenario the poorest fifth of households bear a cost equal to 4.0% of their mean net income against 1.4% for the richest fifth (9.9% against 1.6% as a mean of ratios), even though the cash amounts run the other way — £943 against £1,524.
